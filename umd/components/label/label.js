...
(function (factory) {
    ...
    var Label = /** @class */ (function (_super) {
        ...
        Label.ctorParameters = function () { return [
            ...
            { type: String, decorators: [{ type: core_1.Attribute, args: ['floating',] }] },
            { type: String, decorators: [{ type: core_1.Attribute, args: ['stacked',] }] },
            { type: String, decorators: [{ type: core_1.Attribute, args: ['fixed',] }] },
            { type: String, decorators: [{ type: core_1.Attribute, args: ['inset',] }] }
        ]; };
